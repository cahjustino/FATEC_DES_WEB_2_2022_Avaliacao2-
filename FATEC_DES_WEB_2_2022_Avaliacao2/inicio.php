<?php
    ...
    if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){ // se loggedin no session ou loggedin não valido  ir para index.php
    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            <div class="navbar-header">
                <h3 class=" text-black">Justinos Futebol Clube</h3>
            </div>
            <div class="btn-right ">
            ...
            <table class="data-table">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">Número_partidas</th>
                        <th class="text-center">Número_expulções</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
